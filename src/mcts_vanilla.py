...
#         # Start at root
#         node = root_node
#         if (i > 1000): # break from while loop if 50 rollouts are done
#             #print(node.tree_to_string(horizon=4))
#             break
#         new_node = traverse_nodes(node, board, sampled_game, identity_of_bot)
#         #print('traversed')
#         while len(new_node.untried_actions) > 0:
#             leaf_node = expand_leaf(new_node, board, sampled_game)
#             #print('expanded', leaf_node.parent.child_nodes.keys())
#         #print(node.parent_action)
#         sampled_game = board.next_state(sampled_game, leaf_node.parent_action)
#         rollout_rest = rollout(board, sampled_game)
#         win_rate = board.points_values(rollout_rest)[identity_of_bot] == 1
# #        print('winrate', win_rate)
#         backpropagate(leaf_node, win_rate)
#         i += 1
#         # Do MCTS - This is all you!
#     best_move = None
#     best_win_rate = -1.0
...
#     # estimated win rate.
#     print(root_node.tree_to_string(horizon=1))
#     print("best move picked:", best_move, 'with winrate:', best_win_rate*100)
#     return best_move